...
class UnitTests(unittest.TestCase):
    def test_calculate(self):
        ...
        self.assertAlmostEqual(actual, expected, "/n/nExpected different output when calling 'calculate()' with '[2,6,2,8,4,0,1,5,7]'/n/n")
    ...
    def test_calculate2(self):
        ...
        self.assertAlmostEqual(actual, expected, "/n/nExpected different output when calling 'calculate()' with '[9,1,5,3,3,3,2,9,0]'/n/n")
